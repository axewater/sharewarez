...
This version updates the database schema AUTOMATICALLY, if you already had it installed ... 
it should go smooth, but be aware I will update the database schema as we go along versions.
