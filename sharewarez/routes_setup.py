...
from sharewarez.utils.setup import is_setup_required, set_setup_step, mark_setup_complete, get_current_setup_step
...
def setup_igdb():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            from sharewarez.init_data import initialize_library_folders, insert_default_scanning_filters, initialize_default_settings, initialize_allowed_file_types, initialize_discovery_sections
