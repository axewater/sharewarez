                    ...
                    if (data.results && data.results.length > 0) {
                        data.results.forEach(game => {
                            ...
                            resultItem.addEventListener('click', function() {
                                ...
                                document.querySelector('#summary').value = game.summary || ''; // Handle case where summary might be undefined
                                document.querySelector('#storyline').value = game.storyline || ''; // Handle case where storyline might be undefined
