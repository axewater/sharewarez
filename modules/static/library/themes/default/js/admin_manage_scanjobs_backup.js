...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const scanJobsTable = $('#scanJobsTable').DataTable({
        ...
        order: [[10, 'desc']], // Sort by Last Run Time column (index 10)
        ...
        columnDefs: [
            ...
            { targets: [6,7,8,9,10,11,12,13], visible: false }, // Hide detail columns by default
            { targets: '_all', searchable: true },
            // Column width specifications
            { targets: 0, width: '80px' }, // Job ID
            { targets: 1, width: '120px' }, // Library
            { targets: 3, width: '100px' }, // Status
            { targets: 5, width: '120px' }, // Actions
        ],
