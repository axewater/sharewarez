...
def test_smtp_connection(host, port, username=None, password=None, use_tls=True, timeout=10):
    """
    ...
    try:
        ...
        # Initialize SMTP connection with debugging
...
def main():
    ...
    success, result = test_smtp_connection(
        host=args.host,
        port=args.port,
